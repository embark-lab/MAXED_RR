...
Descriptive statistics for the sample are presented in @tbl-descriptives-1 and @tbl-descriptives-2.

```{r tbl-descriptives}
#| label: tbl-descriptives
#| tbl-cap: Differences in Biomarker Measurements Across ED and HC Groups
#| tbl-subcap:
#| - "Demographic and Key Baseline Variables Across Group"

load("results/demo_table.RData")
load("results/preaim_table.RData")

# join tables by binding rows to preaim table -- make NA if column doesn't exist
demo_table <- demo_table |>
  full_join(preaim_table, by = "Variable")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
#| label: tbl-milkshake
#| tbl-cap: "PAAS, FCQ, and BISS Ratings Before and After Milkshake Ingestion"
